...
// or const ordered = inventors.sort((a,b)=>a.year > b.year ? 1 : -1 )
console.log(byBirthDate)

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const totalYears = inventors.reduce((prev, cur)=> ((prev) + (cur.passed - cur.year)), 0)
console.log(totalYears)

// 5. Sort the inventors by years lived
const byYearsLived = inventors.sort((a, b) => (b.passed-b.year) - (a.passed-a.year))
...
const byAlphabet = people.sort((lastOne, nextOne)=> {
